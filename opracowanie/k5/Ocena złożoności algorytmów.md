1. K5 podział złożoności na
czasowe i pamięciowe oraz na
pesymistyczne, optymistyczne,
średnie, notacja wielkiego O (co
oznacza), inne notacje: theta,
wielkiej omegi, małego O, małej
omegi, jak ocenić złożoność
algorytmu, własności notacji
wielkiego O, klasy problemów
Pytanie: Co oznacza n w zapisie
O(n) albo O(n^2) itd. Odpowiedź:
jest to rozmiar problemu
2. K5 to co w opracowaniu - co to
złożoność, wymieniłem czasową,
pamięciową, asymptotyczne
tempo wzrostu, różne notacje
(duże O, omega itp.), klasy
złożoności, szybko wspomniałem
o problemach z klasy P i NP
- bez pytań
# opracowanie z dysku
