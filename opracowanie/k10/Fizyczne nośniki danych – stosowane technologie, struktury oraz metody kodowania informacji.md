1. K: Wytłumaczyłem w dwóch
zdaniach czym jest nośnik /
nośnik optyczny. Podałem:
LaserDisc, CD, DVD, BD, HD
DVD. Podałem ich pojemności,
ilość warstw, podział na R, RW i
ROM. Wytłumaczyłem też krótko
zapis na płycie (że wypala się
pity, a między nimi są landy) i jak
się je potem odczytuje
).
# Opracowanie z dysku
